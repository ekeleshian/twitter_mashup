...
def get_args():
    ...
    parser.add_argument('--model_name', metavar='MODEL',
                        help='name of the model you want to download 124M,355M,774M,1558M', required=True)
    ...
    parser.add_argument('--models_dir', metavar='PATH', help='name of the directory where the model is saved ',
                        default='./models')
    parser.add_argument('--combine', metavar='CHARS',
                        help='Concatenate files with <|endoftext|> separator into chunks of this minimum size', type=int,
                        default=50000)
    parser.add_argument('--batch_size', metavar='SIZE',
                        help='number of examples it will train on at a time ', default=1, type=int)
    ...
    parser.add_argument('--checkpoint_dir', metavar='PATH', default='./checkpoint',
                        help='The directory to save checkpoints in')
    parser.add_argument('--sample_every', type=int, metavar='N', default=100,
                        help='After how many steps do you want to generate a sample')
    parser.add_argument('--sample_length', type=int, metavar='TOKENS', default=1024,
                        help='size of the generated sameple')
    parser.add_argument('--sample_num', type=int, metavar='N', default=1,
    ...
    parser.add_argument('--max_checkpoints', type=int, default=1,
                        help='how many checkpoints can exists together in the directory')
    parser.add_argument('--use_memory_saving_gradients', type=bool, default=False,
                        help='Use gradient checkpointing to reduce vram usage')
    parser.add_argument('--only_train_transformer_layers', type=bool, default=False,
